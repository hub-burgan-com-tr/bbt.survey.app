namespace Business.Constants
{
    ...
    {
        public static string VoteBeforeAm = "Oy kullanıldı.Teşekkürler...";
        public static string VoteFailed = "Bugün oy kullandınız.Yarın tekrar oy kullanabilirsiniz.";
        ...
        public static string UserInfoCheck = "Kullanıcı eklendi";
        public static string UserInfoAdd = "Kullanıcı databaseden getirildi.";
